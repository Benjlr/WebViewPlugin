...
extern "C" {
JNICALL void Java_com_trufflecoindustries_viewtobuffer_ViewToPBORenderer_glUtilReadPixels(JNIEnv *env, jobject,
                                                                           jint x, jint y,
                                                                           jint width,
                                                                           jint height,
                                                                           jint pboId) {
...
JNICALL jbyteArray
Java_com_trufflecoindustries_viewtobuffer_ViewToPBORenderer_glUtilGetPboBuffer(JNIEnv *env, jobject thiz,
